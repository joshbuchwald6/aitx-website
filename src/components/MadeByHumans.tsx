...
const MissionSection = () => {
  return (
    <section id="mission" className="w-full bg-white py-0">
          ...
          <div className="bg-no-repeat bg-cover bg-center p-4 sm:p-5 min-h-[250px] sm:min-h-[350px] flex flex-col justify-between" style={{
            ...
            <div className="flex items-center text-white">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-xl font-bold">AITX</span>
                <span className="text-white text-sm opacity-80">.ai</span>
              </div>
            </div>
